...
const dictEn: { [key in keyof Dict]: string } = {
  ...
  'schemas.text.indent': 'Indent',
  layout: 'Layout',
  layoutShowMargins: 'Show margins',
  layoutShowGrid: 'Show grid',
  layoutSnapToGrid: 'Snap to grid',
  layoutGridSpacing: 'Grid spacing',
  layoutElementSpacing: 'Element spacing',
  layoutGridUnit: 'Grid unit',
  layoutMarginTop: 'Margin top',
  layoutMarginRight: 'Margin right',
  layoutMarginBottom: 'Margin bottom',
  layoutMarginLeft: 'Margin left',
  layoutAlignTo: 'Align to',
  layoutAlignToSelection: 'Selection',
  layoutAlignToPage: 'Page',
  layoutAlignToContent: 'Content margins',
  layoutMoveIntoContent: 'Move into content area',
  layoutSnapMargin: 'Margin',
  layoutSnapGuide: 'Ruler guide',
  layoutSnapGrid: 'Grid',
  layoutSnapField: 'Field edge',
  layoutSnapPageCentre: 'Page centre',
  layoutSnapPageEdge: 'Page edge',
  'schemas.text.indentLeft': 'Left indent',
  'schemas.text.indentRight': 'Right indent',
  'schemas.text.indentSpecial': 'Special',
  'schemas.text.indentNone': 'None',
  'schemas.text.indentFirstLine': 'First line',
  'schemas.text.indentHanging': 'Hanging',
  'schemas.text.indentBy': 'By',
  'schemas.text.widthMode': 'Width',
  'schemas.text.heightMode': 'Height',
  'schemas.text.sizeFixed': 'Fixed',
  'schemas.text.sizeAuto': 'Auto',
  'schemas.text.sizeFill': 'Fill',
  'schemas.text.expansionBoundary': 'Expand until',
  'schemas.text.boundaryPage': 'Page edge',
  'schemas.text.boundaryMargin': 'Page margin',
  'schemas.text.boundaryField': 'Another field',
  'schemas.text.boundaryManual': 'Manual size',
  'schemas.text.boundaryOverlap': 'Allow overlap',
